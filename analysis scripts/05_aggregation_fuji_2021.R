...
#load("./output/Rdata/fuji data/fuji_results_aggregated_2021_2024_03_31.Rdata")
...
#fuji_local_list_2021 |> map("request") |> map_chr("object_identifier")
...
save(fuji_metrics_tests, file = "./output/Rdata/fuji data/fuji_metrics_tests_2021_2024_05_11.Rdata")
...
#   map_dfr(
#     seq_along(fuji_local_list_2021),
#     ~ bind_rows(fuji_local_list_2021[[.x]][["results"]][[11]][["output"]]) |>
#       mutate(rd_id = fuji_local_list_2021[[.x]][["request"]][["object_identifier"]])
#   ) |>
#   mutate_all(str_trim) |>
#   mutate_all(na_if, "") |>
...
save.image(file = "./output/Rdata/fuji data/fuji_all_2021_2024_05_11.Rdata")
...
save(fuji_results_all, file = "./output/Rdata/fuji data/aggregated_fuji_results_all_2021_2024_05_11.Rdata")
