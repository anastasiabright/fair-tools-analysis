...
eva_zenodo <- bind_cols(result_df_f, result_df_a, result_df_i, result_df_r)# |>
  #select(-c('score_earned...10', `score_earned...23`, `score_earned...36`,`score_earned...47`))
...
save.image("output/Rdata/eva data/aggregated_eva_scores_zenodo.Rdata")
save(eva_zenodo, file = "./output/Rdata/eva data/eva_df_zenodo.Rdata")
