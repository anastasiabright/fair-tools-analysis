...
#accent_palette <- brewer.pal(n = 8, name = "Accent")
...
save(selected_articles, file = "selected_articles.Rdata")
...
# # Convert the summary tables to data frames
# summary_fuji <- as.data.frame(summary(selected_articles) %>% filter(repository_type == "disciplinary repository"))
# summary_enough <- as.data.frame(summary(selected_articles) %>% filter(repository_type == "disciplinary repository"))
# summary_checker <- as.data.frame(summary(selected_articles) %>% filter(repository_type == "disciplinary repository"))
# 
# plot_fuji_sample <- plot_ly(selected_articles, 
#                             y = ~fuji_percent, 
#                             color = ~repository_type, 
#                             type = "violin", 
#                             colors = c(paired_palette[1], paired_palette[3]),
#                             name = ~paste("FUJI -", repository_type)) %>%
#   add_markers(data = summary_fuji,
#               x = ~"FUJI",
#               y = ~mean_fuji_percent,
#               color = I("#1F78B4"),  # Set color for mean point
#               symbol = "circle",     # Use circle as symbol for mean point
#               size = 5,              # Set size of mean point
#               showlegend = FALSE) %>%
#   add_markers(data = summary_fuji,
#               x = ~"FUJI",
#               y = ~median_fuji_percent,
#               color = I("#E31A1C"),  # Set color for median point
#               symbol = "triangle-up",  # Use triangle-up as symbol for median point
#               size = 5,              # Set size of median point
#               showlegend = FALSE) %>%
#   layout(title = "FAIRness selected articles", 
#          yaxis = list(title = "Score in %"),
#          showlegend = FALSE)
# 
# plot_enough_sample <- plot_ly(selected_articles, 
#                               y = ~enough_score_metrics_percent, 
#                               color = ~repository_type, 
#                               type = "violin", 
#                               colors = c(paired_palette[1], paired_palette[3]),
#                               name = ~paste("FAIR Enough -", repository_type)) %>%
#   # Add mean and median markers for FAIR Enough
#   add_markers(data = summary_enough,
#               x = ~"FAIR Enough",
#               y = ~mean_enough_score_metrics_percent,
#               color = I("#1F78B4"),
#               symbol = "circle",
#               size = 5,
#               showlegend = FALSE) %>%
#   add_markers(data = summary_enough,
#               x = ~"FAIR Enough",
#               y = ~median_enough_score_metrics_percent,
#               color = I("#E31A1C"),
#               symbol = "triangle-up",
#               size = 5,
#               showlegend = FALSE) %>%
...
#          showlegend = FALSE)
# 
# plot_checker_sample <- plot_ly(selected_articles, 
#                                y = ~fair_checker_score, 
#                                color = ~repository_type, 
#                                type = "violin", 
#                                colors = c(paired_palette[1], paired_palette[3]),
#                                name = ~paste("FAIR-Checker -", repository_type)) %>%
#   # Add mean and median markers for FAIR Checker
#   add_markers(data = summary_checker,
#               x = ~"FAIR Checker",
#               y = ~mean_fair_checker_score,
#               color = I("#1F78B4"),
#               symbol = "circle",
#               size = 5,
#               showlegend = FALSE) %>%
...
#          showlegend = FALSE)
# 
# subplot(plot_fuji_sample, plot_enough_sample, plot_checker_sample, shareY = TRUE)
...
# plot_fuji_gen_sample <- plot_ly(sample_general, y = ~fuji_percent, type = "box", name = "FUJI") |>
#   layout(title = "General-purpose repositories on sample", yaxis = list(title = "Score in %"),
#          showlegend = FALSE)
# 
# plot_enough_gen_sample <- plot_ly(sample_general, y = ~enough_score_metrics_percent, type = "box", name = "FAIR Enough") |>
#   layout(title = "General-purpose repositories on sample", yaxis = list(title = "Score in %"),
#          showlegend = FALSE)
# 
# plot_checker_gen_sample <- plot_ly(sample_general, y = ~fair_checker_score, type = "box", name = "FAIR-Checker") |>
#   layout(title = "General-purpose repositories on sample", yaxis = list(title = "Score in %"),
#          showlegend = FALSE)
# 
# subplot(plot_fuji_gen_sample, plot_enough_gen_sample, plot_checker_gen_sample, shareY = TRUE)

#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#+ Specific sample
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# 
# plot_fuji_spec_sample <- plot_ly(sample_specific, y = ~fuji_percent, type = "box", name = "FUJI") |>
#   layout(title = "Discipline-specific repositories on sample", yaxis = list(title = "Score in %"),
#          showlegend = FALSE)
# 
# plot_enough_spec_sample <- plot_ly(sample_specific, y = ~enough_score_metrics_percent, type = "box", name = "FAIR Enough") |>
#   layout(title = "Discipline-specific repositories on sample", yaxis = list(title = "Score in %"),
#          showlegend = FALSE)
# 
# plot_checker_spec_sample <- plot_ly(sample_specific, y = ~fair_checker_score, type = "box", name = "FAIR-Checker") |>
#   layout(title = "Discipline-specific repositories on sample", yaxis = list(title = "Score in %"),
#          showlegend = FALSE)
# 
# subplot(plot_fuji_spec_sample, plot_enough_spec_sample, plot_checker_spec_sample, shareY = T)
...
# eva_cleaned <- eva_df[eva_df$id %in% joined_cleaned$id,]
# df_eva_overlapping <- eva_cleaned |>
#   select(c(article, id, eva_score_rda_f1_01d, eva_score_rda_f1_02d, eva_score_rda_f1_02m,  
#            eva_score_rda_f1_01m, eva_score_rda_f2_01m, #score_rda_f3_01m, score_rda_f4_01m, 
#            eva_score_rda_i1_01d, eva_score_rda_i1_01m, eva_score_rda_i1_02d,eva_score_rda_i1_02m,eva_score_rda_i2_01m, 
#            eva_score_rda_i2_01d, eva_score_rda_i2_01m, eva_score_rda_i3_01d, eva_score_rda_i3_01m, 
#            eva_score_rda_i3_02d, eva_score_rda_i3_02m, eva_score_rda_i3_03m, eva_score_rda_i3_04m, 
#            eva_score_rda_r1_1_01m, eva_score_rda_r1_1_02m, eva_score_rda_r1_1_03m)) |>
#   mutate(eva_score = round(((eva_score_rda_f1_01d + eva_score_rda_f1_02d + eva_score_rda_f1_02m +  
#                               eva_score_rda_f1_01m + eva_score_rda_f2_01m + #score_rda_f3_01m + score_rda_f4_01m + 
#                               eva_score_rda_i1_01d + eva_score_rda_i1_01m + eva_score_rda_i1_02d +eva_score_rda_i1_02m +eva_score_rda_i2_01m + 
#                               eva_score_rda_i2_01d + eva_score_rda_i2_01m + eva_score_rda_i3_01d + eva_score_rda_i3_01m + 
#                               eva_score_rda_i3_02d+ eva_score_rda_i3_02m+ eva_score_rda_i3_03m+ eva_score_rda_i3_04m+ 
#                               eva_score_rda_r1_1_01m+ eva_score_rda_r1_1_02m+ eva_score_rda_r1_1_03m)/23), digits = 2))
...
save(selected_articles_overlap, file="./output/Rdata/selected_articles_overlapping_indicators.Rdata")
...
# enough_checker_selected_articles <- df_enough_checker |>
#   group_by(repository) |>
#   sample_n(1) |>
#   ungroup() # 44
