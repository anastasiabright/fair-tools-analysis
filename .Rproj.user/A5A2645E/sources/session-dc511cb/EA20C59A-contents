...
save(fair_enough_summary, file = "output/Rdata/fair-enough/fair_enough_df_overall_scores_2024_05_10.Rdata")
write.csv2(fair_enough_summary, "./output/csv/fair_enough_df_overall_scores_2021_2024_03_31.csv", row.names = F)
...
write.csv2(fair_enough_df, "./output/fair_enough_df_20240510.csv", row.names = F)

#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Combine full scores and individual metrics ----
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
load("output/Rdata/fair-enough data/fair_enough_df_overall_scores_2024_05_10.Rdata")
...
save(fair_enough_df_full, file= "output/Rdata/fair enough/fair_enough_df_combined_2024_05_11.Rdata")
write.csv2(fair_enough_df_full, 
           file = "output/Rdata/fair enough/fair_enough_df_combined_2024_05_11.csv", row.names = F)
save.image("./output/Rdata/fair enough/aggregation_fair_enough_2024_05_11.Rdata")
