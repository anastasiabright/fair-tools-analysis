...
# 26 instead of 39
enough_zenodo <- fair_enough_df_full[fair_enough_df_full$ID %in% eva_zenodo$guid & !is.na(fair_enough_df_full$enough_score_metrics_count),]
fuji_zenodo <- fuji_results_all[fuji_results_all$best_identifier %in% enough_zenodo$ID,]
checker_zenodo <- fair_checker_summary_wide_full[fair_checker_summary_wide_full$target_uri %in%
                                                   enough_zenodo$ID,]
eva_zenodo <- eva_zenodo[eva_zenodo$guid %in% enough_zenodo$ID,]
